...
name: Discord.Events.InteractionCreate,
    ...
    readdirSync('./commands').forEach(f => {
      ...
      if(interaction.commandName.toLowerCase() === cmd.name.toLowerCase()) {
        ...
        if(!rulesisread) {
          ...
          .setTitle("> ・Kuralları kabul etmek için **Kabul Ediyorum.** butonuna tıklayın!\n> ・Tek Kural Vardır **Kötüye Kullanımda Picadorbot Geliştiricileri Sorumluluk Almaz")
 ...
 .addComponents(
  ...
  interaction.reply({ content: `<a:picatik:1292862379700518944> **|** Senin için bir tane destek kanalı ${channel} oluşturldu.`, ephemeral: true })
...
if(interaction.customId === 'giriscikis'){
  ...
  return interaction.update({ embeds: [embed], components: [row1] })
    ...
    if(interaction.customId === "rol_everyone") {
      ...
      interaction.reply({content: "<:tik5:1302296745874817084> | Rol Başarıyla Verildi!", ephemeral: true})
       } else {
         
        interaction.member.roles.remove(butonrol)
      interaction.reply({content: "<:tik5:1302296745874817084> | Rol Başarıyla Alındı!", ephemeral: true})
    }
      }
...
if (interaction.customId == "levelsistemi_" + interaction.user.id) {
    ...
    const row2 = new Discord.ActionRowBuilder()
     ...
     const embed = new EmbedBuilder()
    .setTitle("> <a:reklam_yildirim1:1291895214029410327> | Picador - Level Menüsü!")
    .addFields(
        { name: "**> <:Slash_command:1293564699144618076> </level-sistemi:1053000987285127254>**", value: `> <a:picasoru:1292869111940120646> **Level sistemini açarsın!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level-log ayarla:1053000987285127252>**", value: `> <a:picasoru:1292869111940120646> **Level logu ayarlarsın!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level:1053000987285127255>**", value: `> <a:picasoru:1292869111940120646> **Levelini görüntülersin!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level-ekle:1053000987285127251>**", value: `> <a:picasoru:1292869111940120646> **Level eklersin!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level-kaldır:1053000987285127253>**", value: `> <a:picasoru:1292869111940120646> **Level kaldırırsın!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level-arka-plan:1053750137077387334>**", value: `> <a:picasoru:1292869111940120646> **Level arkaplanını ayarlarsın!**`, inline: true },
        { name: "**> <:Slash_command:1293564699144618076> </level-sıralaması:1053000987285127250>**", value: `> <a:picasoru:1292869111940120646> **Level sıralamasını görüntülersin!**`, inline: true }
     )
...
if (interaction.customId == "captchasistemi_" + interaction.user.id) { 
    ...
    const row2 = new Discord.ActionRowBuilder() 
        .addComponents( 
          ...
          const embed = new EmbedBuilder()
          .setTitle("> <a:reklam_yildirim1:1291895214029410327> | Picador - Captcha Menüsü!")
          .addFields(
            { name: "**> <:Slash_command:1293564699144618076> </captcha-sistemi:1064125585166708918>**", value: `> <a:picasoru:1292869111940120646> **Captcha sistemini açarsın!**`, inline: true },
            { name: "**> <:Slash_command:1293564699144618076> </captcha-görüntüle:1064125585166708917>**", value: `> <a:picasoru:1292869111940120646> **Captcha istatistiklerini görüntülersin!**`, inline: true },
			{ name: "**> <:Slash_command:1293564699144618076> </captcha-sistemi-sıfırla:1068963862600220732>**", value: `> <a:picasoru:1292869111940120646> **Captcha sistemini sıfırlarsın!**`, inline: true }
          )
          .setColor("Random")
            interaction.update({embeds: [embed], components: [row, row2]})
        }
        ...
        .setEmoji("1292862379700518944")
        .setCustomId("evetoylama_everyone"),
        new Discord.ButtonBuilder()
        .setStyle("Danger")
        .setLabel(`(${dataHayır}) Hayır`)
        .setEmoji("1292864428043276430")
        ...
        interaction.deferUpdate();
          ...
          if (interaction.customId === "muteonay_"+interaction.user.id) {
            ...
            const dmb = deleteMessageButton(interaction, {
              ...
              emoji: "<:deleteicon:1293558846257893417>"
        });
            let muterol = db.fetch(`rol_${interaction.guild.id}`)
            let ucanEssek = interaction.guild.members.cache.get(kullanıcı)
            if (!ucanEssek) return interaction.reply("<a:picacarpi2:1292864428043276430> | Üyeyi bulamadım.")
            ucanEssek.roles.add(muterol)
            const embed = new EmbedBuilder()
            .setDescription(`<a:picatik:1292862379700518944> | Başarılı bir şekilde <@!${kullanıcı}> isimli kişiye mute atıldı.
        `)
          ...
          if (interaction.customId === "mutered_"+interaction.user.id) {
            ...
            const dmb = deleteMessageButton(interaction, {
              label: "Mesajı sil.",
              style: Discord.ButtonStyle.Secondary,
              emoji: "<:deleteicon:1132330673907179600>"
        });
            const embed = new EmbedBuilder()
            .setDescription(`<a:picatik:1292862379700518944> | Başarılı bir şekilde mute iptal edildi.
        `)
            interaction.update({embeds: [embed], components: [row, dmb]})
          }
            ...
            **__${interaction.guild.name} Sunucu Kuralları__**                                    
            ...
            interaction.guild.channels.create({name: "💬・sohbet", type: ChannelType.GuildText}).then(sohbet => {
                ...
                .setTitle('Picador Bot - İyi günler diler.')
            ...
            if (interaction.customId === "sunucukurred_"+interaction.user.id) {
              interaction.update({content: `<a:picatik:1292862379700518944> | Başarılı bir şekilde sunucu kurma iptal edildi!`, embeds: [], components: []})
            } 
          ...
          .setLabel("Yenile")
          .setStyle(Discord.ButtonStyle.Secondary)
          .setEmoji('1293559021554503680')
          .setCustomId("yenile_"+interaction.user.id))
          .addComponents(
            new Discord.ButtonBuilder()
                .setEmoji("1293558846257893417")
                .setLabel(" ")
                .setStyle(Discord.ButtonStyle.Secondary)
                .setCustomId(".clearMessageButton_"+interaction.user.id)
          )
          ...
          var basDolu = "<:basdolubar:1293557175272210474>";
          var basBos = "<:basbosbar:1293557072587132949>";
          var ortaDolu = "<:ortadolubar:1293557245724069930>";
          var ortaBos = "<:ortabosbar:1293557212568092754>";
          var sonDolu = "<:sondolubar:1293557286786175070>";
          var sonBos = "<:sonbosbar:1293557321167015957>";
            ...
            let members = client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()
              ...
              .addFields(
                { name: '<a:DeveloperShine:1293555467901210634> Bot Sahibi', value: `**picador_so2**`, inline: true },
            ...
            if (interaction.customId === "botekle_everyone") {
              ...
              .setTitle("<a:picacarpi2:1292864428043276430> | Başarısız!")
          ...
          if (interaction.customId === "ayarlar_"+interaction.user.id) {
            ...
            const yetki = new Discord.EmbedBuilder()
                .setTitle("<a:picacarpi2:1292864428043276430> | Yetersiz Yetki!")
                .setDescription("> Bu komutu kullanabilmek için `Yönetici` yetkisine ihtiyacın var!")
                .setFooter({ text: "Picador" })
                .setColor("Red")
        ...
        if (interaction.customId === "kapat_"+interaction.user.id) {
          ...
          const embed1 = new Discord.EmbedBuilder()
              .setTitle("<a:picatik:1292862379700518944> | Başarıyla Sıfırlandı!")
      ...
      .setTitle('Picador - Özel Oda Kullanıcı Ekleme!')
        ...
        if(interaction.customId === "ekle_"+interaction.user.id){
          ...
          if (!odasiz) return interaction.reply({content: "<a:picacarpi2:1292864428043276430> | Sana Ait Bir Oda Bulamadım!", ephemeral: true})
          await interaction.showModal(mod);
        }

        const mod2 = new ModalBuilder()
        .setCustomId('eklemenu2')
        .setTitle('Picador - Özel Oda Kullanıcı Çıkarma!')
          ...
          if (interaction.customId === "unban_everyone") {
            ...
            if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<a:picacarpi2:1292864428043276430> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            const embed1 = new Discord.EmbedBuilder()
                .setTitle("<a:picatik:1292862379700518944> | Başarılı!")
        ...
        if (interaction.customId === "reddet_everyone") {
          ...
          if(!interaction.member.permissions.has(botlistadmin)) return interaction.reply({content: `<a:picacarpi2:1292864428043276430> | Bu butonu sadece <@&${botlistadmin}> yetkisi olanlar kullanabilir!`, ephemeral: true})
            ...
            if (!interaction.member.roles.cache.has(botlistadmin)) return interaction.reply({ content: "<a:picacarpi2:1292864428043276430> | Bu işlemi gerçekleştirmek için <@&" + botlistadmin + "> rolüne sahip olmalısın!", ephemeral: true })
            ...
            const embed = new EmbedBuilder()
                .setTitle("<a:picacarpi2:1292864428043276430> | Bot Reddedildi!")
        ...
        const embed = new Discord.EmbedBuilder()
        .setAuthor({ name: "Picador Destek Menüsü", iconURL: client.user.displayAvatarURL({ dynamic: true })})
        ...
        .setColor('Blue')
          ...
          if(find) {
            ...
            .setDescription(`<a:picacarpi2:1292864428043276430> Zaten bir talebin bulunmakta.`)
        ...
        if(interaction.customId === `ticketClose_everyone`) {
          ...
          .setDescription(`<a:picatik:1292862379700518944> | Bu destek talebi kapatılmıştır.`)
          .setColor('Green')
        ...
        if(interaction.customId === `ticketDelete_everyone`) {
         ...
         const usr = db.fetch(`ticketUser_${x}${interaction.guild.id}`);
          ...
          .addFields(
            { name: "Destek Açan: <a:duyuru:1293553898212167732>", value: `<@${usr.whOpen}>`, inline: true },
...
if(interaction.customId === `benıdogrula_everyone_${interaction.guild.id}${interaction.user.id}`)
      ...
      await interaction.showModal(giriscikismodal);
        ...
        if(interaction.customId === `giriscikismesajsifirla_`+interaction.user.id) {
          ...
          if (!sayacmessage) {
              const date = new EmbedBuilder()
              .setDescription(`<a:picacarpi2:1292864428043276430> | Bu sistem zaten kapalı!`)
          ...
          .setColor(0x2F3136)
          .setAuthor({ name: `${interaction.user.tag}`, iconURL: `${interaction.user.displayAvatarURL()} ` })
          .setDescription("<a:picatik:1292862379700518944> **|** Giriş çıkış mesajı sıfırlandı!")
